...
CREATE  TABLE IF NOT EXISTS `startuperia`.`values_history` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_values_history_startups` (`startups_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `startuperia`.`orders` (
  ...
  `created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_orders_startups1` (`startups_id` ASC) ,
  INDEX `fk_orders_users1` (`users_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `startuperia`.`stocks` (
  ...
  `created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_stocks_startups1` (`startups_id` ASC) ,
  INDEX `fk_stocks_users1` (`users_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `startuperia`.`news` (
  ...
  `created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ,
  PRIMARY KEY (`news_id`) ,
  INDEX `fk_news_startups1` (`startups_id` ASC) ,
